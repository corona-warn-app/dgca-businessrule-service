...
public class CCLRuleController {
    ...
    @Operation(
        summary = "Gets the a list of all ccl rule ids and hash values.",
        description = "This method returns a list containing the ids and hash values of all ccl "
    ...
    public ResponseEntity<List<CCLRuleListItemDto>> getRules(
        ...
        if (rulesList.isPresent()) {
            ...
            responseEntity = ResponseEntity.ok(cclRuleService.getRulesList());
        }
